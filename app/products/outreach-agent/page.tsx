      ...
      >
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            ...
            <p
              className="text-[#bbbbbb] mb-10 max-w-2xl"
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/book"
                className="w-full sm:w-auto px-8 py-4 bg-[#cc2200] text-[#f0ede8] font-medium rounded hover:bg-[#e02800] transition-colors text-base text-center"
              >
                Book a Pilot
              </Link>
              <a
                href="#how-it-works"
                className="w-full sm:w-auto px-8 py-4 text-center text-[#d4830a] hover:text-[#e8960d] transition-colors text-base"
              >
                See How It Works →
              </a>
            </div>
          ...
          <div className="flex flex-col gap-4">
            {steps.map((step, i) => (
              <FadeIn key={i} delay={i * 0.07}>
                ...
                >
                  <span
                    className="font-bold text-[#888888] flex-shrink-0 w-8 pt-0.5"
                    style={{ fontSize: "13px" }}
                  >
                    {step.num}
                  </span>
            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.08}>
                <div
                  ...
                  style={{ backgroundColor: "#161616", border: "1px solid #222222" }}
                >
                  <p className="font-bold text-[#f0ede8] mb-2" style={{ fontSize: "16px" }}>
                    {item.label}
                  </p>
                  <p className="text-[#888888] text-sm">{item.sub}</p>
                </div>
              </FadeIn>
            ))}
          </div>
            ...
            >
              <div className="grid grid-cols-3 gap-8 mb-8">
                {[
                  ...
                  <div key={i}>
                    <p
                      className="font-bold text-[#f0ede8] mb-1"
                      style={{ fontSize: "clamp(28px, 4vw, 40px)" }}
                    >
                      {item.num}
                    </p>
                    <p className="text-[#888888] text-sm">{item.label}</p>
                  </div>
                ))}
              </div>
              <div
              ...
              >
                <p className="text-[#bbbbbb] text-sm mb-1">Ongoing retainer</p>
                <p className="font-bold text-[#f0ede8] text-lg">
                  $150 – $700 / month{" "}
      ...
      <section className="py-28 px-6" style={{ backgroundColor: "#111111" }}>
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            ...
            <Link
              href="/book"
              className="inline-block px-10 py-4 bg-[#cc2200] text-[#f0ede8] font-medium rounded hover:bg-[#e02800] transition-colors text-base"
            >
              Book a Pilot Call
            </Link>
