...
export default function CareersPage() {
  return (
    <>
                ...
                >
                  ...
                  <div className="flex-shrink-0">
                    <a
                      ...
                      className="inline-block px-6 py-3 bg-[#cc2200] text-[#f0ede8] text-sm font-medium rounded hover:bg-[#e02800] transition-colors whitespace-nowrap"
                    >
                      Apply →
                    </a>
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {perks.map((perk, i) => (
              <FadeIn key={i} delay={i * 0.06}>
                ...
                >
                  <span
                    className="text-[#d4830a] mr-2 font-bold"
                    style={{ fontSize: "18px" }}
                  >
                    →
                  </span>
      ...
      {/* CTA */}
      <section className="py-28 px-6 text-center" style={{ backgroundColor: "#111111" }}>
